<!-- META: P64 | module:harness | status:designing | last:2026-07-20 -->

# P64 plan-execute：计划执行 + Fidelity 审计一站式 Workflow

> 日期：2026-07-20 | 状态：设计中
> 触发：用户需求——在现有 superpowers 指导基础上补充实施后自动反复对照计划文件检查的环节
> 设计文档：[2026-07-20-plan-execute-design.md](../../../docs/superpowers/specs/2026-07-20-plan-execute-design.md)
